...
export const ALL_CHARACTERS: Character[] = [
  ...
  // --- SSR ---
  { id: 2,  name: 'ケナ氏',             title: '映えの女神',       rarity: 'SSR', emoji: '📸', atk: 290, def: 150, hp: 4200, image: '/images/characters/kenashi.png', skill: { name: '映えの極致', description: '眩い光で敵の戦意を削ぐ', type: 'debuff', multiplier: 2.0, effectValue: 0.7, cost: 40 } },
  ...
  { id: 11, name: '桑の葉仙人',         title: '糖を断つ者',       rarity: 'SR',  emoji: '🍵', atk: 190, def: 250, hp: 5200, image: '/images/characters/mulberry.png', skill: { name: '糖質遮断の法', description: '敵のパワーを吸収する', type: 'debuff', multiplier: 1.0, effectValue: 0.5, cost: 30 } },
